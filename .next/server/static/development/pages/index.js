...
const withConnect = Object(react_redux__WEBPACK_IMPORTED_MODULE_0__["connect"])(mapStateToProps, mapDispatchToProps);
const enhance = Object(redux__WEBPACK_IMPORTED_MODULE_1__["compose"])(_lib_redux__WEBPACK_IMPORTED_MODULE_4__["withRedux"], withConnect);
const Home = enhance(_IndexPage_index__WEBPACK_IMPORTED_MODULE_3__["default"]);
/* harmony default export */ __webpack_exports__["default"] = (Home);
...
const actionSetFirstStatePiece = ({
  firstStatePiece
}) => ({
  type: FIRST_ACTION,
  firstStatePiece
...
const {
  DEV
} = _next_config__WEBPACK_IMPORTED_MODULE_10___default.a.default.env;

if (DEV) {
  composeEnhancers = middleware => Object(redux_devtools_extension__WEBPACK_IMPORTED_MODULE_8__["composeWithDevTools"])(middleware);
} else {
  composeEnhancers = middleware => middleware;
}

const setFirstStatePiece = ({
  firstStatePiece
}) => dispatch => dispatch(actionSetFirstStatePiece({
  firstStatePiece
}));
const initializeStore = (preloadedState = initialState) => {
  return Object(redux__WEBPACK_IMPORTED_MODULE_7__["createStore"])(reducer, preloadedState, composeEnhancers(Object(redux__WEBPACK_IMPORTED_MODULE_7__["applyMiddleware"])(redux_thunk__WEBPACK_IMPORTED_MODULE_9___default.a)));
};
...
module.exports = __webpack_require__(/*! d:\repos\nextJS\next-ts-boilerplate\pages\index\index.js */"./pages/index/index.js");
